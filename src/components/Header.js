        ...
        <div className="hidden md:flex flex-1 justify-between items-center">
          ...
          <div className="flex items-center space-x-8">
            ...
            <nav className="flex space-x-8">
                <button className="text-gray-400 font-medium hover:text-black" onClick={() => navigate('/#features')}>{t('What you get')}</button>
                <button 
                  className={`font-medium hover:text-black ${
                  isActive('/pricing') ? 'text-black' : 'text-gray-400'
                  }`} 
                ...
                <button  
                  className={`font-medium hover:text-black ${
                  isActive('/api') ? 'text-black' : 'text-gray-400'
                  }`} 
                  onClick={() => navigate('/api')}
                >
                  {t('API')}</button>
                <button className="text-gray-400 hover:text-black" onClick={() => window.location.href = 'https://podium.page/login'}>{t('Log In')}</button>
            </nav>
